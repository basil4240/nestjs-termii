...
-   [x] **2.7: Conversations API (`ConversationsService`)**

    -   [x] Implement Conversation methods (`list`, `toggleRead`, `send`)

    -   [x] Write unit tests for `ConversationsService`.

    -   [x] Create example for `ConversationsService`.
